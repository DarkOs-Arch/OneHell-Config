...
globalkeys = my_table.join(
    ...
    function ()
        awful.spawn(string.format("dmenu_run -c -l 10 -g 4 -b -p 'DarkOs: ' -fn 'scientifica:size=12'",
        beautiful.bg_normal, beautiful.fg_normal, beautiful.bg_focus, beautiful.fg_focus))
	end,
    ...
    awful.key({ modkey1, "Shift" }, "Print", function() awful.util.spawn("scrot 'DarkOs-%Y-%m-%d_$wx$h.jpg' -e 'mv $f $$(xdg-user-dir PICTURES)'") end, -- scrot -a $(slop -f '%x,%y,%w,%h') -d 2 (Delayed Selection)
